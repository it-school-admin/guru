...
class RegularSubgroupPojoTest extends AbstractPojoTest {
    ...
    {
        RegularSubgroupPojo regularSubgroupPojo = new RegularSubgroupPojo(convertStringToElement(PLAN_ITEM_WITH_REGULAR_SUBGROUP_XML));
    ...
    {
        RegularSubgroupPojo regularSubgroupPojo = new RegularSubgroupPojo(convertStringToElement(PLAN_ITEM_WITH_PARENT_SUBJECT_XML));
